// Static content extracted from the current site, lightly re-written for the redesign.
// Keeping all your voice; tightening where it helps.

const NOW_YEAR = 2026;
const BIRTH_YEAR = 1994;
const AGE = NOW_YEAR - BIRTH_YEAR - 1; // before Sept 20
...
const PORTFOLIO = {
  ...
  // primary = daily driver; secondary = previously used / recreational
  skills: {
    primary: [
